...
public class ImagePanel extends JPanel implements StatusListener {
    ...
    public ImagePanel(SecurityService securityService) {
        ...
        //set default image
        try {
            currentCameraImage = ImageIO.read(getClass().getClassLoader().getResource("cat.jpg"));
        } catch (IOException e) {
        ...
        addPictureButton.addActionListener(e -> {
            ...
            try {
                ...
                Image tmp1 = new ImageIcon(currentCameraImage).getImage();
                cameraLabel.setIcon(new ImageIcon(tmp1.getScaledInstance(IMAGE_WIDTH, IMAGE_HEIGHT, Image.SCALE_SMOOTH)));
